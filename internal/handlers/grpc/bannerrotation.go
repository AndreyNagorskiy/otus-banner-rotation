...
func (h *BannerRotationHandler) AddBanner(ctx context.Context, req *pb.AddBannerRequest) (*pb.AddBannerResponse, error) {
...
func (h *BannerRotationHandler) RemoveBanner(ctx context.Context, req *pb.RemoveBannerRequest) (*pb.RemoveBannerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "")
}

func (h *BannerRotationHandler) RegisterClick(ctx context.Context, req *pb.RegisterClickRequest) (*pb.RegisterClickResponse, error) {
	return nil, status.Error(codes.Unimplemented, "")
}

func (h *BannerRotationHandler) GetBannerForSlot(ctx context.Context, req *pb.GetBannerRequest) (*pb.GetBannerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "")
}
